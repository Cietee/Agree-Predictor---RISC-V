...
VL_CTOR_IMP(Vtestbench_sra_module) {
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void Vtestbench_sra_module::__Vconfigure(Vtestbench__Syms* vlSymsp, bool first) {
    if (false && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
    if (false && this->__VlSymsp) {}  // Prevent unused
}

Vtestbench_sra_module::~Vtestbench_sra_module() {
}

void Vtestbench_sra_module::_settle__TOP__testbench__TAGE__execute_unit__alu_module__sra_module__1(Vtestbench__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtestbench_sra_module::_settle__TOP__testbench__TAGE__execute_unit__alu_module__sra_module__1\n"); );
    ...
    __Vtemp1 = ((1U & VL_BITSEL_IIII(1,5,3,32, (IData)(vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__sra_module.__PVT__i_imme), 1U))
    ...
    vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__sra_module.__PVT__stage[1U] 
        = __Vtemp1;
    __Vtemp2 = ((1U & VL_BITSEL_IIII(1,5,3,32, (IData)(vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__sra_module.__PVT__i_imme), 2U))
    ...
    vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__sra_module.__PVT__stage[2U] 
        = __Vtemp2;
    __Vtemp3 = ((1U & VL_BITSEL_IIII(1,5,3,32, (IData)(vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__sra_module.__PVT__i_imme), 3U))
    ...
    vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__sra_module.__PVT__stage[3U] 
        = __Vtemp3;
    __Vtemp4 = ((1U & VL_BITSEL_IIII(1,5,3,32, (IData)(vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__sra_module.__PVT__i_imme), 4U))
...
void Vtestbench_sra_module::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtestbench_sra_module::_ctor_var_reset\n"); );
    // Body
