...
VL_INLINE_OPT void Vtestbench_block_FETCH::_combo__TOP__testbench__TAGE__fetch_unit__6(Vtestbench__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtestbench_block_FETCH::_combo__TOP__testbench__TAGE__fetch_unit__6\n"); );
...
VL_INLINE_OPT void Vtestbench_block_FETCH::_sequent__TOP__testbench__TAGE__fetch_unit__8(Vtestbench__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtestbench_block_FETCH::_sequent__TOP__testbench__TAGE__fetch_unit__8\n"); );
    Vtestbench* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void Vtestbench_block_FETCH::_combo__TOP__testbench__TAGE__fetch_unit__9(Vtestbench__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtestbench_block_FETCH::_combo__TOP__testbench__TAGE__fetch_unit__9\n"); );
    Vtestbench* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void Vtestbench_block_FETCH::_combo__TOP__testbench__TAGE__fetch_unit__10(Vtestbench__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtestbench_block_FETCH::_combo__TOP__testbench__TAGE__fetch_unit__10\n"); );
    Vtestbench* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void Vtestbench_block_FETCH::_combo__TOP__testbench__TAGE__fetch_unit__11(Vtestbench__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtestbench_block_FETCH::_combo__TOP__testbench__TAGE__fetch_unit__11\n"); );
    Vtestbench* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void Vtestbench_block_FETCH::_combo__TOP__testbench__TAGE__fetch_unit__12(Vtestbench__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtestbench_block_FETCH::_combo__TOP__testbench__TAGE__fetch_unit__12\n"); );
    Vtestbench* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void Vtestbench_block_FETCH::_combo__TOP__testbench__TAGE__fetch_unit__13(Vtestbench__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtestbench_block_FETCH::_combo__TOP__testbench__TAGE__fetch_unit__13\n"); );
    Vtestbench* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
