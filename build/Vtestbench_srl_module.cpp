...
VL_INLINE_OPT void Vtestbench_srl_module::_combo__TOP__testbench__TAGE__execute_unit__alu_module__srl_module__2(Vtestbench__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtestbench_srl_module::_combo__TOP__testbench__TAGE__execute_unit__alu_module__srl_module__2\n"); );
    ...
    __Vtemp5 = ((1U & VL_BITSEL_IIII(1,5,3,32, (IData)(vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__srl_module.__PVT__i_imme), 1U))
    ...
    vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__srl_module.__PVT__stage[1U] 
        = __Vtemp5;
    __Vtemp6 = ((1U & VL_BITSEL_IIII(1,5,3,32, (IData)(vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__srl_module.__PVT__i_imme), 2U))
    ...
    vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__srl_module.__PVT__stage[2U] 
        = __Vtemp6;
    __Vtemp7 = ((1U & VL_BITSEL_IIII(1,5,3,32, (IData)(vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__srl_module.__PVT__i_imme), 3U))
    ...
    vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__srl_module.__PVT__stage[3U] 
        = __Vtemp7;
    __Vtemp8 = ((1U & VL_BITSEL_IIII(1,5,3,32, (IData)(vlSymsp->TOP__testbench__TAGE__execute_unit__alu_module__srl_module.__PVT__i_imme), 4U))
