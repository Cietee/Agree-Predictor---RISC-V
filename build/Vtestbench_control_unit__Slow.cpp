...
VL_CTOR_IMP(Vtestbench_control_unit) {
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void Vtestbench_control_unit::__Vconfigure(Vtestbench__Syms* vlSymsp, bool first) {
    if (false && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
    if (false && this->__VlSymsp) {}  // Prevent unused
}

Vtestbench_control_unit::~Vtestbench_control_unit() {
}

void Vtestbench_control_unit::_settle__TOP__testbench__TAGE__decode_unit__instr_decode2__1(Vtestbench__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtestbench_control_unit::_settle__TOP__testbench__TAGE__decode_unit__instr_decode2__1\n"); );
...
void Vtestbench_control_unit::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtestbench_control_unit::_ctor_var_reset\n"); );
    // Body
    __PVT__i_instr = VL_RAND_RESET_I(32);
    __PVT__o_ctrl = VL_RAND_RESET_I(14);
    __PVT__opcode = VL_RAND_RESET_I(7);
    __PVT__funct7 = VL_RAND_RESET_I(7);
